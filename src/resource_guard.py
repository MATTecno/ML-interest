...
def _get_swiper_limits(config: dict | None = None) -> tuple[float, float]:
    ...
    return max_used_pct, min_available_mb
...
def is_memory_pressure(
    ...
    max_used_pct, min_available_mb = _get_swiper_limits(config)
    reasons: list[str] = []
